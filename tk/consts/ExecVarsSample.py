...
try:
    ...
    class ExecVars:
        ...
        EDIT_SLEEP_SECS = int(os.environ.get("EDIT_SLEEP_TIME_OUT", 5))
        ...
        STATUS_DEL_TOUT = int(os.environ.get("STATUS_DEL_TOUT", "10"))
        ...
        TOR_MAX_TOUT = int(os.environ.get("TOR_MAX_TOUT", "500"))
